...
<body>
	...
	<section class="product-details spad">
					...
					<div class="product__details__pic">
						<div
							...
							<a class="pt active" href="#product-1"> <img
								src="resources/${getProduct.getImage()}" alt="">
						...
						<div class="product__details__slider__content">
							<div class="product__details__pic__slider owl-carousel">
								...
								<img data-hash="product-2" class="product__big__img"
									src="resources/img/product/details/product-3.jpg" alt="">
								<img data-hash="product-3" class="product__big__img"
									src="resources/img/product/details/product-2.jpg" alt="">
								<img data-hash="product-4" class="product__big__img"
									src="resources/img/product/details/product-4.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
					<div class="col-lg-6">
						<div class="product__details__text">
							...
							<div class="product__details__price">
								<fmt:formatNumber value="${getProduct.getPrice_net()}"
									type="number" maxIntegerDigits="14" />
								đ<span><fmt:formatNumber value="${getProduct.getPrice()}"
										type="number" maxIntegerDigits="14" />đ</span>
							</div>
							...
							<div class="product__details__button">
								<div class="quantity">
									<span>Quantity:</span>
									<div class="pro-qty">
										<input type="text" value="1" id="quanty-cart">
									</div>
								</div>
								<button type="button" value="${getProduct.getId()}" class="cart-btn addcart">
		...
		<div class="row">
			...
			<c:forEach items="${ProductRelated}" var="productre">			
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="resources/${productre.getImage()}">
							<div class="label new">New</div>
							<ul class="product__hover">
								<li><a href="resources/${productre.getImage()}"
									class="image-popup"><span class="arrow_expand"></span></a></li>
								<li><a href="#"><span class="icon_heart_alt"></span></a></li>
								<li><a href="AddCart/${productre.getId()}"> <span class="icon_bag_alt"></span></a></li>
							</ul>
						</div>
						<div class="product__item__text">
							<h6>
								<a href="${productre.getId()}">${productre.getTitle()}</a>
							</h6>
							<div class="rating">
								<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
									class="fa fa-star"></i> <i class="fa fa-star"></i> <i
							...
							<div class="product__price"><fmt:formatNumber value="${productre.getPrice()}" type="number"
				...
				<div class="col-lg-4 col-md-6 col-sm-7">
					<div class="footer__about">
						...
						<div class="footer__payment">
							<a href="#"><img src="resources/img/payment/payment-1.png"
								alt=""></a> <a href="#"><img
								src="resources/img/payment/payment-2.png" alt=""></a> <a
								href="#"><img src="resources/img/payment/payment-3.png"
								alt=""></a> <a href="#"><img
								src="resources/img/payment/payment-4.png" alt=""></a> <a
								href="#"><img src="resources/img/payment/payment-5.png"
								alt=""></a>
						</div>
					</div>
				</div>
	...
	<script>
		$(".addcart").on("click",function(){			
			...
			window.location = "AddCartMul/" + id + "/" + quanty;
		});
	</script>
</body>
