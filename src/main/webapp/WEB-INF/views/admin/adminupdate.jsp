        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form:form action="UpdateProduct" method="POST" commandName="getProductUpdate">
                        <div class="row row-space">
                            <div class="col-6">
                                <div class="input-group">
                                    <label class="label">Name product</label>
                                    <form:input class="input--style-4" type="text" path="title" name="first_name" value="${getProductUpdate.getTitle()}"/>
                                </div>
                            </div>
                             <div class="col-6">
                                <div class="input-group">
                                    <label class="label">Available</label>
                                    <form:input class="input--style-4" type="text" path="available" name="first_name" value="${getProductUpdate.getAvailable()}"/>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <form:input class="input--style-4" type="text" path="price" name="first_name" value="${getProductUpdate.getPrice()}"/>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group">
                                    <label class="label">Price Sale</label>
                                    <form:input class="input--style-4" type="text" path="price_net" name="first_name" value="${getProductUpdate.getPrice_net()}"/>                               
                               </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <form:textarea class="input--style-4" path="description" name="first_name" id="description" row="3"/>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group">
                            		<label class="label">Category</label>
                            			<div class="rs-select2 js-select-simple select--no-search">
                               				 <form:select name="subject" path="category" >
                        	...
                        	<div class="col-6">
                                <div class="input-group">
                                    ...
                                    <form:input id="xFilePath" name="FilePath" path="image" type="text" size="60" />
									<form:input type="button" value="Browse Server" path="image" onclick="BrowseServer();" />                                
                               </div>
                            </div>
                        </div>   
                                            
                        <div class="p-t-15">
                            <button style="color: #fff;" class="btn btn--radius-2 btn--green" type="submit">Update Product</button>
                        </div>
                    </form:form>
                </div>
            </div>
