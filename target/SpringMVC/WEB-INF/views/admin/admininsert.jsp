...
<!-- Icons font CSS-->
<link
	href="resources/admin/vendor/vendor/mdi-font/css/material-design-iconic-font.min.css"
	rel="stylesheet" media="all">
<link
	href="resources/admin/vendor/vendor/font-awesome-4.7/css/font-awesome.min.css"
	rel="stylesheet" media="all">
...
<!-- Vendor CSS-->
<link href="resources/admin/vendor/vendor/select2/select2.min.css"
	rel="stylesheet" media="all">
<link
	href="resources/admin/vendor/vendor/datepicker/daterangepicker.css"
	rel="stylesheet" media="all">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link collapsed"
				...
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-cog"></i> <span>Product</span>
			</a>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">${useradmin}</span>
				...
				<div class="container-fluid">
					<form:form action="AddProduct" method="POST" modelAttribute="productadd" enctype="multipart/form-data">
						<!-- Page Heading -->
										...
										<div class="card card-4">
											<div class="card-body">
												...
												<div class="row row-space">
													<div class="col-6">
														<div class="input-groupform">
															...
															<form:input type="text" path="price_net"
																class="input--style-4" />
														</div>
													</div>
													<div class="col-6">
													...
													<div class="col-6">
														<div class="input-groupform">
															...
															<div class="input-group-icon">
																<form:input class="input--style-4 js-datepicker" type="text" path="deal_timer"/>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row row-space">
													<div class="col-6">
														<div class="input-groupform">
															...
															<div
																...
																<select name="subject">																	
																	<option selected="selected">Women's</option>
																	<option>Men's</option>
																	<option>Kid's</option>
													...
													<div class="col-6">
														<div class="input-groupform">
															<label class="label">Display Location</label>
															<div
																class="rs-select2 js-select-simple select--no-search">
																<select name="subject">
												...
												<div class="row row-space">
													...
													<div class="col-6">
														<div class="input-group">
															...
															<div class="input-groupform">
																<input type="file" class="form-control-file" id="exampleFormControlFile1" name="multiPartServlet"/>
															</div>
														</div>
													</div>
												</div>
